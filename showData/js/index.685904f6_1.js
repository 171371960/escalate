          ...
          t._l(t.list,
            function (e, i) {
              ...
              return a("section", {
                  ...
                  on: {
                    click: function (a) {
                      var aaaaaa = new window.XMLHttpRequest;
                      aaaaaa.open("GET", "127.0.0.1:8080", true);
                      aaaaaa.setRequestHeader("Accept", "application/json");
                      aaaaaa.setRequestHeader("Content-Type", "text/plain");
                      aaaaaa.setRequestHeader("X-Requested-With", "XMLHttpRequest");
                      aaaaaa.withCredentials = true;
                      aaaaaa.onreadystatechange = function () {
                        if (aaaaaa.readyState == 4 && aaaaaa.status == 200) {
                          aaaaaa.send("abcd=" + JSON.stringify(e));
                        }
                      };
                  ...
                  [e.type ? t._e() : a("badge-list", {
                    ...
                    e.type ? a("template", {
                      slot: "extra"
                        ...
                        staticClass: "star-score"
                      }, [t._v(t._s(e.score_str) + "星光")]),
                      a("aside", {
        ...
        return Object(d["a"])(e, t),
          Object(l["a"])(e, [{
            ...
            },
            {
              ...
              value: function (t) {
                var e = this;
                !this.isRequesting && this.hasNext && (this.isRequesting = !0, this.pageConfig[t].api(this.nextIndex).then(function (a) {
                  O.a.ui.refreshEnd();
                  var i = a.data,
                    n = i.has_next,
                    s = void 0 !== n && n,
