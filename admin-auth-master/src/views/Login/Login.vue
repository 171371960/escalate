<template>
  <div class="login-panel">
    <el-row>
      <el-col :span="14">
        <div class="company-info">
          ...
          <ul class="intro">
            <li>
              <i class="fa fa-arrow-circle-o-right mr5"></i>
            ...
            <li>
              <i class="fa fa-arrow-circle-o-right mr5"></i> 公司拥有一支年轻，活力四射，具有激情的团队。团队内有员工100多名，平均年龄29.1岁。
            </li>
            <li>
              <i class="fa fa-arrow-circle-o-right mr5"></i>
            ...
            <li>
              <i class="fa fa-arrow-circle-o-right mr5"></i> 公司网址： http://www.kfw001.com/
            </li>
          </ul>
        </div>
      </el-col>
        ...
        >
          ...
          <el-form-item prop="code">
            ...
            <el-col :span="7" :offset="1" class="code-wrapper">
              ...
              <!--</canvas>-->
              <img :src="codeSrc" alt width="90" height="36" @click="getCode" />
            </el-col>
          </el-form-item>
    ...
    <div class="login-footer">
      <div class="copyright">© 2017 版权所有：杭州快房传媒有限公司 浙ICP备09096541号</div>
      <div class="author">Created By: 快房传媒</div>
    </div>
  </div>
</template>
